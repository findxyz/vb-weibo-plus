...
- [ ] Group Message query views return correctly encoded local preview and original URLs according to media capability, without exposing upstream fid values or media URLs.
...
- [ ] Tests cover nonnumeric fid serialization and persistence, every supported variant, generated local URLs, header and query construction, response-header filtering, local errors, and upstream errors.

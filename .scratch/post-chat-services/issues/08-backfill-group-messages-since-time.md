...
- [ ] ChatService performs time-bound and cursor orchestration only, while MessageMapper and repositories retain all conversion and persistence responsibilities.
